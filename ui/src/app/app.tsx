...
import { ArgoCDContext, AuthSettingsCtx, Provider } from './shared/context';
        ...
        return (
            <React.Fragment>
                ...
                <PageContext.Provider value={{ title: 'Argo CD' }}>
                    <ArgoCDContext.Provider value={{ history, popup: this.popupManager, notifications: this.notificationsManager, navigation: this.navigationManager, baseHref: base }}>
